...
The project has 38 source files across 70 test files with 1053 passing tests including comprehensive property-based tests.
...
├── config/              # 1 test file
├── core/                # 3 test files
├── e2e/                 # 11 test files (tier1–tier3 + helper unit tests)
